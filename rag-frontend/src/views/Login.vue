<template>
  <div class="min-h-screen w-full bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4 relative overflow-hidden">
    <!-- 纸质纹理背景 -->
    ...
    <div class="relative w-full max-w-5xl">
      <div class="bg-white rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.08)] border border-gray-100 overflow-hidden">
        <div class="flex flex-col md:flex-row">
            ...
            <div class="max-w-md mx-auto">
              ...
              <div class="mb-12">
                <div class="inline-flex items-center space-x-2 mb-8">
                  <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-sm">
                  ...
                  <span class="text-xl font-medium text-gray-900">智能销售助手</span>
                </div>
              ...
              <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <button
                  type="submit"
                  :disabled="loading"
                  class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-4 rounded-lg hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                >
          ...
          <!-- 右侧信息区域 -->
          <div class="hidden md:flex md:w-2/5 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-12 items-center justify-center border-l border-gray-100 relative">
            <!-- 装饰性引号 -->
